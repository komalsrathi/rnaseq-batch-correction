...
Rscript code/01-collapse-matrices.R \
--mat input/cohort3a_subset-gene-expression-rsem-tpm.stranded.rds \
--gene_sym FALSE \
...
--matrices "output/cohort3a_subset-gene-expression-rsem-tpm.collapsed.polya.rds, output/cohort3a_subset-gene-expression-rsem-tpm.collapsed.stranded.rds, output/gtex-brain-normals-gene-expression-rsem-tpm.collapsed.polya.rds, output/tgen-brain-normals-gene-expression-rsem-tpm.collapsed.polya.rds" \
...
Rscript code/02-combine-matrices.R \
--matrices "output/cohort3a_subset-gene-expression-rsem-tpm.collapsed.polya.rds, output/cohort3a_subset-gene-expression-rsem-tpm.collapsed.stranded.rds" \
...
Rscript code/02-create-clin.R \
--mat output/cohort3a_subset-gene-expression-rsem-tpm.collapsed.stranded.rds \
--clin input/hgat_all_primary.rds \
--id_col 'Kids_First_Biospecimen_ID' \
--lib_col 'library' \
--study_col 'cohort' \
...
--clin 'input/pnoc003-cohort3a-polya-batch-metadata.rds, input/pnoc003-cohort3a-stranded-batch-metadata.rds, input/gtex-batch-metadata.rds, input/tgen-batch-metadata.rds' \
...
--combined_mat output/pnoc003-cohort3a-gtex-tgen-gene-expression-rsem-tpm.rds \
--combined_clin output/pnoc003-cohort3a-gtex-tgen-metadata.rds \
...
--uncorrected_mat output/pnoc003-cohort3a-gtex-tgen-gene-expression-rsem-tpm.rds \
--corrected_mat output/pnoc003-cohort3a-gtex-tgen-gene-expression-rsem-tpm-corrected.rds \
--combined_clin output/pnoc003-cohort3a-gtex-tgen-metadata.rds \
--tsne_plots pnoc003-cohort3a-gtex-tgen-tsne.pdf \
--density_plots pnoc003-cohort3a-gtex-tgen-density.pdf
